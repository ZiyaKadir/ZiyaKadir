...
🎓 Computer Engineering graduate from **Gebze Technical University** — finished **3rd in my class**<br>
🏫 Completed both **Piscine & Cursus at École 42 Kocaeli** — one of the world's most rigorous peer-learning engineering schools<br>
🌍 **Erasmus exchange** at Politechnika Gdańska, Poland<br>
⚙️ Passionate about **low-level systems** — I like to understand and control everything at the code level (C/C++ first mentality)<br>
🌐 Also experienced in **full-stack web development** — TypeScript, NestJS, React, Next.js, GraphQL, Prisma<br>
🤖 Built real **edge AI systems** — trained and deployed YOLOv8 on Hailo8 NPU for industrial use<br>
🪂 Outside of code: paragliding, cycling, and always chasing the next challenge<br>
